namespace FileSearcher
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox2.Text = "2. Шаблон имени файла(regex):";
			...
			this.groupBox1.Text = "1. Стартовая директория (с которой начинается поиск)";
			// 
			// label1
			// 
			...
			this.label3.MaximumSize = new System.Drawing.Size(200, 78);
			...
			this.groupBox5.Size = new System.Drawing.Size(373, 231);
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(146, 33);
