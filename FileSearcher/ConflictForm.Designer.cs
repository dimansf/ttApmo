namespace FileSearcher
{
	partial class ConflictForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Кажется кто-то забыл указать шаблон для файла или для его содержимого ? ";
			...
			this.button1.Text = "Никогда такого не было и вот опять";
			...
			this.button2.Text = "Внести поправки в конституцию и обнулить президенсткий срок";
